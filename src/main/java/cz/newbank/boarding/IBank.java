...
public interface IBank {
     ...
     */
    Long getBalance(String name) throws AccountNotFoundException;
     ...
     * @throws AccountNotFoundException If acconut is not found in the system.
     */
     ...
     * @throws AccountNotFoundException If either source or target account is not found in the system.
     */
    public void processTransaction(String source, String target, Long amount) throws AccountNotFoundException;
}
